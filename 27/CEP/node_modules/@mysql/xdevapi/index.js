...
const Expr = require('@mysql/xdevapi/lib/Protocol/Protobuf/Adapters/Expr');
const authenticationManager = require('@mysql/xdevapi/lib/Authentication/AuthenticationManager');
const client = require('@mysql/xdevapi/lib/DevAPI/Client');
const locking = require('@mysql/xdevapi/lib/DevAPI/Locking');
const mysql41Auth = require('@mysql/xdevapi/lib/Authentication/MySQL41Auth');
const parseUri = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser');
const plainAuth = require('@mysql/xdevapi/lib/Authentication/PlainAuth');
const query = require('@mysql/xdevapi/lib/DevAPI/Query');
const sha256MemoryAuth = require('@mysql/xdevapi/lib/Authentication/SHA256MemoryAuth');
...
exports.getVersion = function () {
    return require('@mysql/xdevapi/package').version;
};
