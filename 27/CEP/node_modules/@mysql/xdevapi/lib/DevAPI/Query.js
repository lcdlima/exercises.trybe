 ...
 * DataModel.DOCUMENT
 */
const DataModel = require('@mysql/xdevapi/lib/Protocol/Protobuf/Stubs/mysqlx_crud_pb').DataModel;
const MessageType = require('@mysql/xdevapi/lib/Protocol/Protobuf/Stubs/mysqlx_prepare_pb').Prepare.OneOfMessage.Type;
