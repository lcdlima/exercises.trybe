...
const parseAddressList = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseAddressList');
const parseAuthenticationMechanism = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseAuthenticationMechanism');
const parseConnectTimeout = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseConnectTimeout');
const parseSchema = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseSchema');
const parseSecurityOptions = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseSecurityOptions');
const parseUserInfo = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseUserInfo');
const parseConnectionAttributes = require('@mysql/xdevapi/lib/DevAPI/Util/URIParser/parseConnectionAttributes');
