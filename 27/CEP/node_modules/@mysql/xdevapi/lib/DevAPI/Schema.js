...
const collection = require('@mysql/xdevapi/lib/DevAPI/Collection');
const databaseObject = require('@mysql/xdevapi/lib/DevAPI/DatabaseObject');
const deprecated = require('@mysql/xdevapi/lib/DevAPI/Util/deprecated');
const sqlExecute = require('@mysql/xdevapi/lib/DevAPI/SqlExecute');
const table = require('@mysql/xdevapi/lib/DevAPI/Table');
