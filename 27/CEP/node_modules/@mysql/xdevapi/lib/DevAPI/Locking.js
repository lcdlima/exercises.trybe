...
const RowLock = require('@mysql/xdevapi/lib/Protocol/Protobuf/Stubs/mysqlx_crud_pb').Find.RowLock;
const RowLockOptions = require('@mysql/xdevapi/lib/Protocol/Protobuf/Stubs/mysqlx_crud_pb').Find.RowLockOptions;
const preparing = require('@mysql/xdevapi/lib/DevAPI/Preparing');
