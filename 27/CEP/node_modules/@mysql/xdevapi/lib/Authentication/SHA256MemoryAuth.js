...
const authPlugin = require('@mysql/xdevapi/lib/Authentication/AuthPlugin');
const sha256 = require('@mysql/xdevapi/lib/Authentication/Util/crypto').sha256;
const xor = require('@mysql/xdevapi/lib/Authentication/Util/crypto').xor;
