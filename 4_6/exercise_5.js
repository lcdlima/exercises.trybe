...
document.getElementById('one').addEventListener('click', goDark);
document.getElementById('name').addEventListener('keyup', typeAndScream);
document.getElementById('two').addEventListener('click', complainMessage);
document.getElementById('three').addEventListener('click', finishTheStory);